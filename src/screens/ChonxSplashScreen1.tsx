...
export default function ChonxSplashScreen1({ navigation }: any) {
  ...
  return (
    <LinearGradient colors={['#10b981', '#a7f3d0']} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ChonxSplashScreen2')}
          >
