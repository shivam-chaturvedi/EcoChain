...
export default function StudentStructureScreen({ navigation }: any) {
          ...
          <View style={styles.rightCol}>
            <View style={styles.configCard}>
              <View style={styles.configHeader}>
                <Text style={styles.configTitle}>Configure Grade Details</Text>
              ...
              <View style={styles.configList}>
                  ...
                  <View key={g} style={styles.configItem}>
                    ...
                    <View style={styles.configItemGrid}>
                      <View style={styles.configFieldSmall}>
                        <Text style={styles.configLabel}>GRADE</Text>
                        <Text style={styles.configValueLarge}>Grade {g}</Text>
                      </View>
                      <View style={styles.configFieldMedium}>
                        <Text style={styles.configLabel}>SECTION NAMES (COMMA SEPARATED)</Text>
                        <TextInput style={styles.input} value="A, B, C, D" />
                      </View>
                      <View style={styles.configFieldLarge}>
                        <Text style={styles.configLabel}>TOTAL STUDENTS</Text>
                ...
                <View style={styles.moreGradesNote}>
                  <Text style={styles.moreGradesText}>... Rows for Grades 3 through 6 would follow the same structure based on selection ...</Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 24, display: 'none' },
  navBtn: {},
  ...
  configFieldSmall: { minWidth: 100 },
  configFieldMedium: { flex: 2, minWidth: 200 },
  configFieldLarge: { flex: 1, minWidth: 150 },
  configLabel: { fontSize: 12, fontWeight: '700', color: '#3c4a42', marginBottom: 8 },
  configValueLarge: { fontSize: 24, fontWeight: '600', color: '#191c1d' },
  ...
  moreGradesNote: { paddingHorizontal: 12, opacity: 0.8 },
  moreGradesText: { fontSize: 10, fontWeight: '700', color: 'rgba(0,108,73,0.6)', fontStyle: 'italic' },
