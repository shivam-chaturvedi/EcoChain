...
export default function ChallengesOverviewScreen({ navigation }: any) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.grid}>
          ...
          {/* Card 2 */}
          <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('ChallengesOverviewUpdated')} activeOpacity={0.9}>
            <View style={styles.cardImageContainer}>
